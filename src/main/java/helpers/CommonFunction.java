...
public class CommonFunction extends BaseFunction {
	...
	private BaseFunction base = new BaseFunction();
	...
	public WebElement findElementByLocation(String elementToSet) throws Throwable {
		...
		logger.debug("findElemetnByLocation: " + elementToSet);
		...
		case "id":
			element = findElementById(getLocationPath);
			break;
		case "xpath":
			element = findElementByXpath(getLocationPath);
			break;

		default:
			System.out.println("Unable to Find Element in " + locatorConfigPath);
			break;
		}
